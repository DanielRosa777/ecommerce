                            ...
                            <table cellspacing="0" class="shop_table cart">
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-subtotal">
                                        <span class="amount">ice($value.vltotal)"}</span>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cart_totals ">
                                    ...
                                    <table cellspacing="0">
                                        ...
                                        <tr class="shipping">
                                            <th>Frete</th>
                                            <td>R$<?php echo formatPrice($cart["vlfreight"]); ?> <?php if( $cart["nrdays"] > 0 ){ ?><small>prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</small>
                                            <?php } ?></td>
                                        </tr>
